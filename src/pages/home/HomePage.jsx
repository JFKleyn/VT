...
{/* <div className="nav-bar">
    <img src="images/Logo.webp" className="logo" alt="Venture Technologies logo">
    <div className="hidden-a">
        <a href="/">Home</a>
        <a href="/about/">About</a>
        <a href="/services/">Services</a>
        <a href="/services/#ourprocess">Process</a>
  ...
  <div className="about-container">
    <h2 className="reveal">Premium Websites Built for Growth</h2>
    <p className="reveal">We design and develop premium custom websites for businesses that want more than just an online presence. Every project is built with a focus on strategy, performance, and clean modern design to help your business stand out and grow with confidence.</p>

    <p className="reveal">Whether you're launching something new or refining an established brand, we create digital experiences that are designed to support <span>long-term success and growth.</span></p>
  </div>

<!-- ---------------------------------------------------------------------------------------------------------- -->

  <div className="services-container">
    <div className="header-services reveal">
      <h2>Our Services</h2>
      <p>Professional web solutions built around performance, scalability, and long-term growth.</p>
    </div> 
    <div className="services">
      <div className="service reveal">
        ...
        <p>Modern, professionally designed websites built to strengthen your brand and create a better user experience.</p>
        <a className="learn-more" href="services/index.html#webdesign">
          Learn More
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M566.6 342.6C579.1 330.1 579.1 309.8 566.6 297.3L406.6 137.3C394.1 124.8 373.8 124.8 361.3 137.3C348.8 149.8 348.8 170.1 361.3 182.6L466.7 288L96 288C78.3 288 64 302.3 64 320C64 337.7 78.3 352 96 352L466.7 352L361.3 457.4C348.8 469.9 348.8 490.2 361.3 502.7C373.8 515.2 394.1 515.2 406.6 502.7L566.6 342.7z"/></svg>
        </a>
      </div>
      <div className="service reveal">
        ...
        <p>Custom-built websites developed for performance, scalability, and long-term reliability.</p>
        <a className="learn-more" href="services/index.html#webdevelopment">
          Learn More
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M566.6 342.6C579.1 330.1 579.1 309.8 566.6 297.3L406.6 137.3C394.1 124.8 373.8 124.8 361.3 137.3C348.8 149.8 348.8 170.1 361.3 182.6L466.7 288L96 288C78.3 288 64 302.3 64 320C64 337.7 78.3 352 96 352L466.7 352L361.3 457.4C348.8 469.9 348.8 490.2 361.3 502.7C373.8 515.2 394.1 515.2 406.6 502.7L566.6 342.7z"/></svg>
        </a>
      </div>
      <div className="service reveal">
        ...
        <p>Fast, optimized websites built for performance, SEO, and a smoother user experience.</p>
        <a className="learn-more" href="services/index.html#pando">
          Learn More
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M566.6 342.6C579.1 330.1 579.1 309.8 566.6 297.3L406.6 137.3C394.1 124.8 373.8 124.8 361.3 137.3C348.8 149.8 348.8 170.1 361.3 182.6L466.7 288L96 288C78.3 288 64 302.3 64 320C64 337.7 78.3 352 96 352L466.7 352L361.3 457.4C348.8 469.9 348.8 490.2 361.3 502.7C373.8 515.2 394.1 515.2 406.6 502.7L566.6 342.7z"/></svg>
        </a>
      </div>
      <div className="service reveal">
        ...
        <p>Ongoing support and maintenance to keep your website secure, updated, and running smoothly.</p>
        <a className="learn-more" href="services/index.html#sandm">
          Learn More
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M566.6 342.6C579.1 330.1 579.1 309.8 566.6 297.3L406.6 137.3C394.1 124.8 373.8 124.8 361.3 137.3C348.8 149.8 348.8 170.1 361.3 182.6L466.7 288L96 288C78.3 288 64 302.3 64 320C64 337.7 78.3 352 96 352L466.7 352L361.3 457.4C348.8 469.9 348.8 490.2 361.3 502.7C373.8 515.2 394.1 515.2 406.6 502.7L566.6 342.7z"/></svg>
        </a>
      </div>
...
<!-- ---------------------------------------------------------------------------------------------------------- -->
  ...
  <div className="choose-us">
    <div className="choose-us-header reveal">
      <h2>Why Choose Us</h2>
  ...
  <div className="ready reveal">
    <div className="ready-container">
      ...
      <a className="btn read" href="contact/index.html">
        Start Your project
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M566.6 342.6C579.1 330.1 579.1 309.8 566.6 297.3L406.6 137.3C394.1 124.8 373.8 124.8 361.3 137.3C348.8 149.8 348.8 170.1 361.3 182.6L466.7 288L96 288C78.3 288 64 302.3 64 320C64 337.7 78.3 352 96 352L466.7 352L361.3 457.4C348.8 469.9 348.8 490.2 361.3 502.7C373.8 515.2 394.1 515.2 406.6 502.7L566.6 342.7z"/></svg>
      </a>
    </div>
  ...
  <div className="footer">
    <div className="links">
      ...
      <div className="socials">
        ...
        --> <a href="https://www.linkedin.com/company/venture-technologies-co/?viewAsMember=true">
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
