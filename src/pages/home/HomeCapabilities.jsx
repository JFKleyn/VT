...
function CapabilityVisual({ type, number }) {
  return (
    <div
      className={`capability-visual capability-visual--${type}`}
      aria-hidden="true"
    >
      <div className="capability-visual__top">
        <span>Venture / Capability</span>
      ...
      <div className="capability-visual__stage">
        {type === "browser" && (
          <>
            ...
            <div className="visual-cursor">↗</div>
          </>
        )}
        {type === "system" && (
          <>
            <div className="visual-panel visual-panel--one">
              <span />
              <span />
              <span />
            </div>
            <div className="visual-panel visual-panel--two">
              <i />
              <i />
              <i />
              <i />
            </div>
            <svg className="visual-chart" viewBox="0 0 260 100">
              <path d="M5 83 C45 76,54 41,92 57 S150 83,180 40 S225 20,255 10" />
            </svg>
          </>
        )}
        {type === "mobile" && (
  ...
  return (
    <section className="home-capabilities" id="capabilities">
      <div className="home-capabilities__heading">
        <Reveal className="home-capabilities__label">What we build</Reveal>
        <Reveal as="h2" direction="up" delay={0} amount={0.01}>
          Different problems.
          <br />
          <em>The right tools.</em>
        </Reveal>
        <Reveal as="p" delay={150}>
          We choose the technology around the problem—not the other way around.
        </Reveal>
      </div>
      ...
      <div className="home-capabilities__body">
          ...
          {capabilities.map((capability, index) => (
            ...
            >
              ...
              <span className="capability-row__main">
                ...
                <span className="capability-row__mobile-copy">
                  {capability.description}
                </span>
                <span className="capability-row__mobile-outputs">
        ...
        <Reveal
          className="home-capabilities__display"
          direction="right"
          delay={160}
        >
